...
if uploaded_file:
    try:
        ...
        v_usl_cust = get_limit(zh_key, "max", "客戶要求")
        ...
        if data_col:
            ...
            if view_mode == "View 1: Phân bố & Trending":
                ...
                with col_right:
                    st.subheader("Trending & Multi-Level Limits")
                    fig_trend = go.Figure()
                    ...
                    fig_trend.update_layout(template="plotly_white", margin=dict(r=220), xaxis_title="Sequence", yaxis_title="Value")
